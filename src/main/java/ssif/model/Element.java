...
public class Element implements Serializable {
	...
	private String name;
	private Set<String> tags; // = new HashSet<String>(); //an element can have multiple tags (two, if it is
								// an antonym)
	...
	// this method checks whether the element contains any tag in the Set passed as
	// parameter
